...
class ServicePrice extends Component {
    ...
    handleEditClick(event) {
        window.location.href = UrlRedirect.ServicePriceEditor + `/${event.target.name}`;
    }
...
class ServicePriceManagement extends Component {
    render() {
        return (
            <BrowserRouter>
                <div>
                    <Route exact={true} path={UrlRedirect.ServicePrices} component={ServicePrice} />
                    <Route exact={true} path={UrlRedirect.ServicePriceCreator} component={ServicePriceCreator} />
                    <Route exact={true} path={UrlRedirect.ServicePriceEditor + "/:id"} component={ServicePriceEditor} />
                </div>
            </BrowserRouter>
        );
    }
