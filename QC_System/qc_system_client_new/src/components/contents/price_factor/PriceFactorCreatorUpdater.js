...
class RenderProperties extends Component {
    ...
    onCancel(){
        window.location.href = UrlRedirect.PriceFactors;
    }
...
export class PriceFactorCreator extends Component {
    render() {
        return (
...
export class PriceFactorEditor extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        console.log(2);
        Request.get(UrlApi.PriceFactor + "/" + paraId)
            .set('x-auth', localStorage.getItem('x-auth'))
            .then((res) => {
