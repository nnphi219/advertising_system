exports.Date2GreaterThanOrEqualDate1 = (date1, date2) => {
...
exports.JsonDateIsInTheMiddleOfTime = (checkedDate, start_date, end_date) => {
    if (Date2GreaterThanOrEqualDate1(start_date, checkedDate) && Date2GreaterThanOrEqualDate1(checkedDate, end_date)) {
        return true;
    }
    else {
        return false;
