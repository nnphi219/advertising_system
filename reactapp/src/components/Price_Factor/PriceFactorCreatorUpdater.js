            ...
            <div>
                ...
                <div>
                    <label key={"don_gia_co_ban"} className="fullwidth">
                        {"Đơn giá cơ bản"}
                        <input type="text" id={"don_gia_co_ban"} key={"don_gia_co_ban"} name={"don_gia_co_ban"} value={this.props.stateValues.don_gia_co_ban} onChange={this.props.OnChangeInput} className="pricefactor--input" />
                    </label>
                </div>
                <div>
                ...
                <div>
                    <label key={"phan_tram_tang_giam"} className="fullwidth">
                        {"Phần trăm tăng/giảm (%)"}
                        <input type="text" id={"phan_tram_tang_giam"} key={"phan_tram_tang_giam"} value={this.props.stateValues.phan_tram_tang_giam} name={"phan_tram_tang_giam"} onChange={this.props.OnChangeInput} className="pricefactor--input" />
                    </label>
                </div>
                <div>
                    <label key={"gia_tri_thuc"} className="fullwidth">
                        {"Tổng tiền"}
                        <input type="text" id={"gia_tri_thuc"} key={"gia_tri_thuc"} name={"gia_tri_thuc"} onChange={this.props.OnChangeInput} className="pricefactor--input" />
                    </label>
                </div>
            ...
            <div className='popup_inner--pricefactor'>
                ...
                <div className="pricefactor_information">
                    ...
                    <RenderProperTies
                        ...
                        OnChangeRadioButton={this.OnChangeRadioButton.bind(this)}
                    />
                </div>
